...
import { Button, Container, Row, Col, Modal, Form, Toast, ToastContainer, Card } from "react-bootstrap";
...
function IndividualAccount() {
    ...
    const handleDeletePayment = async (paymentId) => {
        try {
            const res = await fetch(`http://localhost:8080/api/transactions/payment/${paymentId}`, {
                method: "DELETE",
                credentials: "include"
            });
